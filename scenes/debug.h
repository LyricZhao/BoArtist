...
Object* objects[] = {
    // new Plane(Vector3D(0, 1. / 120), DIFF, 1.5, Texture("sources/bo.jpg", Color_F()), Color_F(), Vector3D(0, 120), Vector3D(1), Vector3D(0, 0, 1)),
    ...
    new Cube(Vector3D(0, 100, 0), Vector3D(20, 100, 0), Vector3D(0, 120, 0), Vector3D(0, 100, 20), DIFF, 1.5, Texture(), Color_F(3, 3, 3))
}; 
