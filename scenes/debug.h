...
Vector3D light_point(0, 90, 0), u(1, 0, 0), v(0, 1, 0), w(0, 0, 1);
...
Object* objects[] = {
    ...
    new Plane(Vector3D(0, 0, -1. / 5), DIFF, 1.5, Texture("", Color_F(0.75, 0.25, 0.75)), Color_F()),
    new Plane(Vector3D(1. / 5, 0, 0), DIFF, 1.5, Texture("", Color_F(0.75, 0.25, 0.75)), Color_F()),
    new Plane(Vector3D(-1. / 5, 0, 0), DIFF, 1.5, Texture("", Color_F(0.75, 0.25, 0.75)), Color_F()),
    new Plane(Vector3D(0, 1. / 120), DIFF, 1.5, Texture("", Color_F(0.75, 0.25, 0.75)), Color_F()),
