...
int width = 1024, height = 1024, samples = 10;

Ray camera(Vector3D(50,52,295.6), Vector3D(0, -0.042612, -1).norm());

Sphere spheres[] = {
  Sphere(1e5, Vector3D( 1e5 + 1,  40.8, 81.6), Color_F(), Color_F(.75, .25, .25), DIFF), // Left
  Sphere(1e5, Vector3D(-1e5 + 99, 40.8, 81.6), Color_F(), Color_F(.25, .25, .75), DIFF), // Rght
  Sphere(1e5, Vector3D(50, 40.8, 1e5), Color_F(), Color_F(.75, .75, .75), DIFF), // Back
  Sphere(1e5, Vector3D(50, 40.8, -1e5 + 170), Color_F(), Color_F(), DIFF), // Frnt
  ...
  Sphere(16.5, Vector3D(27, 16.5, 47), Color_F(), Color_F(.999, .999, .999), SPEC), // Mirr
  Sphere(16.5, Vector3D(73, 16.5, 78), Color_F(), Color_F(.999, .999, .999), REFR), // Glas
