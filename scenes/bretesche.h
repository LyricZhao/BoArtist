...
double r_alpha = 0.7, sppm_radius = 1, energy = 0.1, camera_scale = 0.07;
...
Object* objects[] = {
    new Sphere(100, Vector3D(0, 200, 200), 1.5, Texture(), DIFF, Color_F(6, 6, 6)),
    new Mesh(Vector3D(0, 200, 0), "sources/Bretesche.obj", DIFF, 1.5, 1, Texture("sources/Bretesche.jpg", Color_F(1, 1, 1) * 0.8)),
...
const char output[] = "outputs/Bretesche_pt";
};
