...
int width = 2560, height = 1440, samples = 200;
...
double r_alpha = 0.7, sppm_radius = 0.05, energy = 0.01, camera_scale = 0.07;
...
Object* objects[] = {
    new Sphere(100, Vector3D(0, 200, 200), 1.5, Texture(), DIFF, Color_F(1, 1, 1)),
